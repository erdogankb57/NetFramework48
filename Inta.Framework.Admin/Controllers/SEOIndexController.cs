    ...
    public class SEOIndexController : Controller
    {
        ...
        public ActionResult GetList(PagingDataListRequest<SEOIndex> request)
        {
            ...
            var selectData = pagingData.Select(s => new
            {
                ...
                Edit = "<a href='javascript:void(0)' onclick=\"$PagingDataList.AddRecordModal('/SEOIndex/Add','True'," + s.Id.ToString() + ")\">Düzenle</a>",
                Delete = "<a href='javascript:void(0)' onclick=\"$PagingDataList.DeleteRecordModal('SEOIndexList','/SEOIndex/Delete',SearchDataList," + s.Id.ToString() + ")\">Sil</a>"
            }).ToList();
